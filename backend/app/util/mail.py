...
async def send_verification_email(email: str, token: str) -> None:
    ...
    if CONFIG.mail_console or CONFIG.prod.lower() == "dev":
        ...
        <table align="center" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:auto;background-color:white;border-radius:8px;overflow:hidden;">
            <tr>
            <td style="background-color:#20477B;padding:20px 30px;text-align:center;">
                <h1 style="color:white;margin:0;font-size:24px;">MyServer</h1>
            </td>
            </tr>
            <tr>
            <td style="padding:30px;color:#333;">
                ...
                Welcome to <strong>MyServer</strong>!  
                ...
                <p style="font-size:14px;color:#555;margin-top:40px;">Thanks,<br/>The MyServer Team</p>
            </td>
            </tr>
            <tr>
